...
import importlib
import os
conf = importlib.import_module('configures.inria2sn2.{}'.format(version)).conf

solver_conf = conf['solver_conf']
solver_conf['solver_name'] = 'test_{}'.format(version)
...
eval_conf['plot_sim_mat'] = True
eval_conf['num_cluster'] = 3
eval_conf['save_cls_imgs'] = False
